...
extension Image {
    ...
    static func draw(in context: CGContext, maze: Grid, cellSize: Int, strokeSize: Int = 2, solution: Bool = false, showGrid: Bool = false, imageHeight: Int) {
    ...
    static func cgImage(for maze: Grid, cellSize: Int, strokeSize: Int = 2, solution: Bool = false, showGrid: Bool = false ) -> CGImage? {
        ...
        if let context = Image.context( size: (imageWidth+1, imageHeight+1), color: (1.0, 1.0, 1.0, 0.0)) {
            ...
            Image.draw(in: context, maze: maze, cellSize: cellSize, strokeSize: strokeSize, solution: solution, showGrid: showGrid, imageHeight: imageHeight)
